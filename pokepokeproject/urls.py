"""
URL configuration for pokepokeproject project.
...
urlpatterns = [
    ...
    #pokepokeアプリへのURLパターン
    path('', include('pokepoke.urls')),
    ...
    #パスワードリセットページ
    path('reset/<uidb64>/<token>', auth_views.PasswordResetCompleteView.as_view(template_name = "password_reset_form.html"), name = 'password_reset_confirm'),
    #パスワードリセット完了ページ
